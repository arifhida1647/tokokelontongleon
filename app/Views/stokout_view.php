...
<body class="hold-transition sidebar-mini">
    ...
    <script>
        function hapus(id) {
            ...
            if (result) {
                window.location = "<?= site_url('stokout/hapus') ?>/" + id;
            }
        }

        function edit($id) {
            $.ajax({
                url: "<?= site_url('stokout/edit') ?>/" + $id,
                type: "get",
