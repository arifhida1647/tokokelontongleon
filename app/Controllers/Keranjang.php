...
class Keranjang extends Controller
{
    ...
    public function index()
    {
        ...
        $data['dataKeranjang'] = $this->model
            ->select('tb_transaksi.*, tb_item.nama_item as item_name, tb_item.harga as item_price, tb_item.unit')
        ...
        $data['dataItem'] = $this->modelItem
            ->select('tb_item.*') // Sesuaikan tipe join jika diperlukan (inner, left, right, dll.)
